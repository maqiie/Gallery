...
const ScreenSaver = ({ projectId }) => {
  ...
  .loader {
    ...
    background: transparent; /* Ensure loader is visible on top */
  }

  .loader div {
    position: absolute;
    width: 100px; /* Increased width */
    height: 62px; /* Increased height */
  }
  ...
  .loader div div span {
    position: absolute;
    width: 8px; /* Increased loader bar width */
    height: 100%;
    background: white; /* Loader bar color */
    z-index: 999999;
  }
  ...
  .h4 {
    top: 20px; /* Adjusted for increased size */
    left: 46px; /* Adjusted for increased size */
  ...
  @keyframes load4 {
    0% {
      top: 74px; /* Adjusted for increased size */
      left: 46px; /* Adjusted for increased size */
      height: 268%; /* Adjusted for increased size */
    }
